...
public class MenuProductoController {
    ...
    public @ResponseBody RespuestaServicioVO crear(@RequestBody MenuProducto menuProducto) {
    ...
    public @ResponseBody RespuestaServicioVO actualizar(@RequestBody MenuProducto menuProducto) {
