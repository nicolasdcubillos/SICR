...
public class RestauranteService {
    ...
    Logger logger = LoggerFactory.getLogger(RestauranteService.class);
    ...
    public RespuestaServicioVO getById(Integer id) {
        ...
        try {
            ...
            respuesta.setObjeto(restaurante);
    ...
    public RespuestaServicioVO getAll() {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            Iterable<Restaurante> coldatos = repository.findAll();
    ...
    public RespuestaServicioVO getByPage(Integer numeroPagina, Integer registrosPorPagina, String ordenarPor,
        ...
        try {
            ...
            Iterable<Restaurante> page = repository.getByPage(pageable);
    ...
    public RespuestaServicioVO crear(Restaurante restaurante) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = crearTX(restaurante);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
    ...
    public RespuestaServicioVO crearTX(Restaurante restaurante) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
    ...
    public RespuestaServicioVO actualizar(Restaurante restaurante) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = actualizarTX(restaurante);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
            respuesta.setDescripcionExcepcion(e.getMessage() + " - " + e.getRootCause().getMessage());
    ...
    @Transactional(rollbackFor = Exception.class)
    public RespuestaServicioVO actualizarTX(Restaurante restaurante) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        Restaurante aux = null;
        aux = repository.findById(restaurante.getId()).get();
        if (aux != null) {
            restaurante.setId(aux.getId());
            repository.save(restaurante);
            respuesta.setObjeto(restaurante);
            respuesta.setExitosa(true);
