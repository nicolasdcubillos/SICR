...
public class TipoMiembroService {
    ...
    Logger logger = LoggerFactory.getLogger(TipoMiembroService.class);

    @Autowired
    private TipoMiembroRepository repository;

    public RespuestaServicioVO getById(Integer id) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            TipoMiembro tipoMiembro = repository.findById(id).get();
            respuesta.setObjeto(tipoMiembro);
    ...
    public RespuestaServicioVO getAll() {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            Iterable<TipoMiembro> coldatos = repository.findAll();
    ...
    public RespuestaServicioVO getByPage(Integer numeroPagina, Integer registrosPorPagina, String ordenarPor,
        ...
        try {
            ...
            Iterable<TipoMiembro> page = repository.getByPage(pageable);
    ...
    public RespuestaServicioVO crear(TipoMiembro tipoMiembro) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = crearTX(tipoMiembro);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
    ...
    public RespuestaServicioVO crearTX(TipoMiembro tipoMiembro) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        repository.save(tipoMiembro);
        respuesta.setObjeto(tipoMiembro);
        respuesta.setExitosa(true);
        return respuesta;
    }

    public RespuestaServicioVO actualizar(TipoMiembro tipoMiembro) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = actualizarTX(tipoMiembro);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
            respuesta.setDescripcionExcepcion(e.getMessage() + " - " + e.getRootCause().getMessage());
    ...
    @Transactional(rollbackFor = Exception.class)
    public RespuestaServicioVO actualizarTX(TipoMiembro tipoMiembro) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        TipoMiembro aux = null;
        aux = repository.findById(tipoMiembro.getId()).get();
        if (aux != null) {
            tipoMiembro.setId(aux.getId());
            repository.save(tipoMiembro);
            respuesta.setObjeto(tipoMiembro);
            respuesta.setExitosa(true);
