...
public class SedeRestauranteController {
    ...
    public @ResponseBody RespuestaServicioVO crear(@RequestBody SedeRestauranteDTO sedeRestauranteDTO) {
        return service.crear(sedeRestauranteDTO);

    }

    @CrossOrigin(origins = origen)
    @RequestMapping(value = "/actualizar", method = RequestMethod.POST)
    public @ResponseBody RespuestaServicioVO actualizar(@RequestBody SedeRestauranteDTO sedeRestauranteDTO) {
        return service.actualizar(sedeRestauranteDTO);
    }
