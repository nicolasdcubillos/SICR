...
public class EstadoProductoService {
    ...
    Logger logger = LoggerFactory.getLogger(EstadoProductoService.class);
    ...
    public RespuestaServicioVO getById(Integer id) {
        ...
        try {
            EstadoProducto estadoProducto = repository.findById(id).get();
            respuesta.setObjeto(estadoProducto);
    ...
    public RespuestaServicioVO getAll() {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            Iterable<EstadoProducto> coldatos = repository.findAll();
    ...
    public RespuestaServicioVO getByPage(Integer numeroPagina, Integer registrosPorPagina, String ordenarPor,
        ...
        try {
            ...
            Iterable<EstadoProducto> page = repository.getByPage(pageable);
    ...
    public RespuestaServicioVO crear(EstadoProducto estadoProducto) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = crearTX(estadoProducto);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
    ...
    public RespuestaServicioVO crearTX(EstadoProducto estadoProducto) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        repository.save(estadoProducto);
        respuesta.setObjeto(estadoProducto);
        respuesta.setExitosa(true);
        return respuesta;
    }

    public RespuestaServicioVO actualizar(EstadoProducto estadoProducto) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = actualizarTX(estadoProducto);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
            respuesta.setDescripcionExcepcion(e.getMessage() + " - " + e.getRootCause().getMessage());
    ...
    @Transactional(rollbackFor = Exception.class)
    public RespuestaServicioVO actualizarTX(EstadoProducto estadoProducto) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        EstadoProducto aux = null;
        aux = repository.findById(estadoProducto.getId()).get();
        if (aux != null) {
            estadoProducto.setId(aux.getId());
            repository.save(estadoProducto);
            respuesta.setObjeto(estadoProducto);
            respuesta.setExitosa(true);
