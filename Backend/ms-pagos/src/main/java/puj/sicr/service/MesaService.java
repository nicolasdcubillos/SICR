...
public class MesaService {
    ...
    public RespuestaServicioVO getById(Integer id) {
        ...
        try {
            Mesa mesa = repository.findById(id).get();
            respuesta.setObjeto(mesa);
    ...
    public RespuestaServicioVO getAll() {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            Iterable<Mesa> coldatos = repository.findAll();
    ...
    public RespuestaServicioVO getByPage(Integer numeroPagina, Integer registrosPorPagina, String ordenarPor,
        ...
        try {
            ...
            Iterable<Mesa> page = repository.getByPage(pageable);
    ...
    public RespuestaServicioVO crear(Mesa mesa) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = crearTX(mesa);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
    ...
    public RespuestaServicioVO crearTX(Mesa mesa) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
    ...
    public RespuestaServicioVO actualizar(Mesa mesa) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        try {
            respuesta = actualizarTX(mesa);
        } catch (DataAccessException e) {
            respuesta.setObjeto(null);
            respuesta.setExitosa(false);
            respuesta.setDescripcionExcepcion(e.getMessage() + " - " + e.getRootCause().getMessage());
    ...
    @Transactional(rollbackFor = Exception.class)
    public RespuestaServicioVO actualizarTX(Mesa mesa) {
        RespuestaServicioVO respuesta = new RespuestaServicioVO();
        Mesa aux = null;
        aux = repository.findById(mesa.getId()).get();
        if (aux != null) {
            mesa.setId(aux.getId());
            repository.save(mesa);
            respuesta.setObjeto(mesa);
            respuesta.setExitosa(true);
